...
call s:CondDefSetting('g:p4Depot', 'vg')
...
call s:CondDefSetting('g:p4EnableMenu', 1)
...
call s:CondDefSetting('g:p4DebugMessages', 0)
call s:CondDefSetting('g:p4UseP4Cmds', 0)
...
command! -nargs=0 PFInitialize :call perforce#Initialize(1)
command! -nargs=0 PluginHelp :help perforce
...
"command! -nargs=* -complete=file E :call perforce#PFOpenAltFile(0, <f-args>)"Commented by shreedr
"command! -nargs=* -complete=file ES :call perforce#PFOpenAltFile(2, <f-args>)" Commented by shreedr
