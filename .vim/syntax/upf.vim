...
syn keyword upfParameter -function
syn keyword upfParameter -update
syn keyword upfParameter -logic_expr
syn keyword upfParameter -supply_expr
syn keyword upfParameter -source
syn keyword upfParameter -sink
syn keyword upfParameter -supply
syn keyword upfParameter -object_list
syn keyword upfParameter -power
syn keyword upfParameter -ground
syn keyword upfParameter -attribute
syn keyword upfParameter -driver_supply
syn keyword upfParameter -receiver_supply
syn keyword upfParameter -handle
...
syn keyword upfStatement		power
syn keyword upfStatement		ground
syn keyword upfStatement		pwell
syn keyword upfStatement		nwell
syn keyword upfStatement		primary
syn keyword upfStatement		default_isolation
syn keyword upfStatement		default_retention
